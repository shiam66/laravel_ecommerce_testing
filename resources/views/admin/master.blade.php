        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; Shiam Hossain 2021</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
...
{{--<script src="{{asset('public/admin/')}}/plugins/sweet_alert/sweetAlert.min.js"></script>--}}
<script src="{{asset('public/admin/')}}/plugins/sweet_alert/sweetaler2.min.js"></script>
