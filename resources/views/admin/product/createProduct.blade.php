                ...
                <div class="card-body">
                    {!! Form::open(['url' => 'product/save', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" class="form-control" id="" name="productQuantity">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" id="mytextarea" rows="8" name="productShortDescription"></textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" id="mytextarea2" rows="8" name="productLongDescription"></textarea>
