...
<div class="product-easy">
    <div class="container">
        ...
        <script type="text/javascript" src="{{asset('public/frontEnd/js/easyResponsiveTabs.js')}}"></script>
        <script type="text/javascript">
                ...
                <div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
                    ...
                    <div class="resp-tabs-container">
                        <div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
                            @foreach($publicProducts as $publicProduct)
                            <div class="col-md-3 product-men">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    <div class="men-thumb-item">
                                        <img src="{{asset($publicProduct->productImages)}}" alt="" class="pro-image-front" height="220px">
                                        <img src="{{asset($publicProduct->productImages)}}" alt="" class="pro-image-back" height="220px">
                                        <div class="men-cart-pro">
                                            <div class="inner-men-cart-pro">
                                                <a href="{{url('/product-details/'.$publicProduct->id)}}" class="link-product-add-cart">Quick View</a>
                                            </div>
                                        </div>
                                        <span class="product-new-top">New</span>
                                    </div>
                                    <div class="item-info-product ">
                                        <h4><a href="{{url('/product-details/'.$publicProduct->id)}}">{{ $publicProduct->productName }}</a></h4>
                                        <div class="info-product-price">
                                            <span class="item_price">BDT {{ $publicProduct->productPrice }}</span>
                                        </div>
