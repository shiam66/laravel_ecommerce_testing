    ...
    <div class="container">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav menu__list">
                            ...
                            <li class=" menu__item"><a class="menu__link" href="{{ url('/category-view/'.$publicCategory->id) }}">{{ $publicCategory->categoryName }}</a></li>
                            @endforeach
        ...
        <div class="top_nav_right">
            <div class="cart box_1">
                ...
                <p><a href="{{ url('/') }}" class="simpleCart_empty">Empty Cart</a></p>
            </div>
        </div>
