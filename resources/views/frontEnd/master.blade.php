...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('public/frontEnd/css/pignose.layerslider.css')}}" media="all" />
    ...
    <script type="text/javascript" src="{{asset('public/frontEnd/js/imagezoom.js')}}"></script>
    <script type="text/javascript" src="{{asset('public/frontEnd/js/jquery.flexslider.js')}}"></script>
    
    <!-- cart -->
    <script type="text/javascript" src="{{asset('public/frontEnd/js/simpleCart.min.js')}}"></script>
    <!-- cart -->
...
@include('frontEnd.includes.coupne')
